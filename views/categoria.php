                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h1 class="box-title">Categoria
                                <button class="btn btn-success" id="btnAgregar" onclick="showForm(true)"><i
                        ...
                        <!-- /.box-header -->
                        <!-- centro -->
                        <div class="col-lg-6 col-xs-6 col-md-6 col-sm-6 panel-body table-responsive"
                             id="listadoregistros">
                            <table id="tbllistado"
                        ...
                        <div class="panel-body table-responsive" style="height: 400px;" id="formularioregistros">
                            ...
                            <form action="" id="formulario" name="formulario" method="post">
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input class="form-control" type="text" name="nombre" id="nombre" maxlength="45"
