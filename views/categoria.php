              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Categoria <button class="btn btn-success" onclick="showForm(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
...
<!--                            Formulario de agrgar categorias-->
                        <form action="" id="formulario" name="formulario" method="post">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input class="form-control" type="text" name="nombre" id="nombre" maxlength="45" placeholder="Nombre de la Categoria" required>
                            </div>
